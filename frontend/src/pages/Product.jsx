        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          {activeTab === "description" && (
            <>
              ...
              <p>
                Our Swap Exchange System, a unique platform where you can trade
                items directly with other users! Whether you’re looking to
                refresh your wardrobe, update your gadgets, or discover new
                treasures, our system makes it easy and convenient.
              </p>
              <RelatedProducts
